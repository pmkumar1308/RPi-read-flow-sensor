...
if __name__ == '__main__':
    ...
    param_dict = {
        ...
        'baseline_voltage_inf' : 2.5,# V
        'baseline_voltage_def' : 3.75, # V
    ...
    param_dict['flow_values_inf']=np.empty(param_dict['NumberOfRuns']+2)
    param_dict['flow_values_def']=np.empty(param_dict['NumberOfRuns']+2)
    ...
    try:
        with open(file_path, "a") as log:     
            ...
            param_dict['i']=0
            param_dict['t']=0
            param_dict = lib.runKelly(param_dict, log)
            ...
            # Cycle between two masses
                ...
                param_dict['baseline_voltage_inf'] = 2.85
                param_dict['baseline_voltage_def'] = 0
                ...
                param_dict['baseline_voltage_inf'] = 0
                param_dict['baseline_voltage_def'] = 3.75
